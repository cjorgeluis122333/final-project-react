                            ...
                            <form className="" onSubmit={onSubmit}>
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control rounded-4" id="floatingInput"
                                           placeholder="FirstName" name={"first_name"} value={state.first_name}
                                ...
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control rounded-4" id="floatingPassword"
                                           placeholder="LastName" name={"last_name"} value={state.last_name}
                                           onChange={onValueChange}/>
                                ...
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control rounded-4" id="career"
                                           placeholder="career" name={"career"} value={state.career}
                                           onChange={onValueChange}/>
                                ...
                                <div className="form-floating mb-3">
                                    <input type="number" className="form-control rounded-4" id="school_year"
                                           placeholder="School year" name={"sch_year"} value={state.sch_year}
                                           onChange={onValueChange}/>
                                ...
                                <div className="form-floating mb-3">
                                    <input type="text" className="form-control rounded-4" id="address"
                                           placeholder="address" name={"address"} value={state.address}
                                           onChange={onValueChange}/>
                                ...
                                <div className="mb-3">
                                    <input type="checkbox" className="form-check-inline rounded-4" id="scholarship"
                                           placeholder="Scholarship" name={"scholarship"} checked={state.scholarship}
                                           onChange={onValueChange}/>
